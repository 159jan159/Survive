...
public class ContainerCrafting : Container
{
    public ContainerCrafting(Inventory containerInventory, Inventory playerInventory): base (containerInventory, playerInventory)
    {
        //Player Hotbar Slots
        for (int i = 0; i < 7; i++)
        {
    ...
    {
        return InventoryManager.INSTANCE.getContainerPrefab("Crafting Container");
    } 
}
