...
public class ContainerShop : Container
{
    public ContainerShop(Inventory containerInventory, Inventory playerInventory): base (containerInventory, playerInventory)
    {
        //Player Hotbar Slots
        for (int i = 0; i < 7; i++)
        {
    ...
    {
        return InventoryManager.INSTANCE.getContainerPrefab("Shop Container");
    } 
}
